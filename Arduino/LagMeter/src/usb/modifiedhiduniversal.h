...
#if !defined(__MODIFIED_HIDUNIVERSAL_H__)
#define __MODIFIED_HIDUNIVERSAL_H__

#include "usbhid.h"
//#include "hidescriptorparser.h"

class ModifiedHIDUniversal : public USBHID {
protected:
        struct ReportParser {
                uint8_t rptId;
...
#endif // __MODIFIED_HIDUNIVERSAL_H__
