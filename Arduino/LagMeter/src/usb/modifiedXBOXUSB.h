...
#ifndef _modified_xboxusb_h_
#define _modified_xboxusb_h_
...
class ModifiedXBOXUSB : public USBDeviceConfig {
public:
	/**
	 * Constructor for the XBOXUSB class.
	 * @param  pUsb   Pointer to USB class instance.
	 */
	ModifiedXBOXUSB(USB* pUsb);
...
protected:
	...
	virtual void readReport(); // read incoming data
